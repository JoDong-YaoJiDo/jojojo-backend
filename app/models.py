...
class TourismPlace(Base):
    ...
    addr1 = Column(String, default="")
    addr2 = Column(String, default="")
    tel = Column(String, default="")
    zipcode = Column(String, default="")
    firstimage = Column(String, default="")
    firstimage2 = Column(String, default="")
    mapx = Column(Float, nullable=True)
    mapy = Column(Float, nullable=True)
    raw_json = Column(Text, nullable=False)
    createdtime = Column(String, default="")
    modifiedtime = Column(String, default="")
...
class Post(Base):
    ...
    tags = relationship("PostTag", cascade="all, delete-orphan", back_populates="post")
...
class PostLike(Base):
    ...
    __table_args__ = (UniqueConstraint("post_id", "client_id", name="uq_post_like"),)
...
class PostBookmark(Base):
    ...
    __table_args__ = (UniqueConstraint("post_id", "client_id", name="uq_post_bookmark"),)
